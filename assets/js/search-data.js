    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          title: 'Travel assistent',
          description: "Projeto que cria um agente capaz de sugerir o local ideial para sua próxima viagem",
          section: "Projects",handler: () => {
              window.location.href = "/projects/2_project/";
            },},{id: "projects-face-recognition",
          title: 'Face recognition',
          description: "Realizando reconhecimento facial com OpenCV",
          section: "Projects",handler: () => {
              window.location.href = "/projects/3_project/";
            },},{id: "projects-medivisão-auxílio-ao-diagnóstico-de-câncer-de-pele",
        ...
        section: 'Socials',
        handler: () => {
          window.open("/assets/pdf/samyhad_cv.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
